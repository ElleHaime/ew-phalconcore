...
class Paginator extends \Engine\Crud\Helper
{
    ...
    static public function _(Grid $grid)
    {
        ...
        $pageParamFrom = $grid->getPaginateFrom();
        $pageParamTo = $grid->getPaginateTo();
        $pageParamCount = $grid->getCount();

        $count = count($grid->getColumns());
        ...
        <nav class=\"navbar navbar-default\">
            <div class=\"container-fluid\">
                <div class=\"navbar-header\">
                    Displaying ".$pageParamFrom."-".$pageParamTo." of ".$pageParamCount." results.
                </div>
     ...
     */
    static function setUrlParam($url, $paramName, $paramValue = false, $urlDecode = false)
    {
