...
{
	/**
	 * Check is value has integer format
	 *
	...
	/**
	 * Check is input value has float format
	 *
	...
	static function translit2rus($text,$type='de')
	{
		...
		$alphas = [
				'Sc' => 'Сц','Ai'=>'Ай','Yii'=>'Ы','Jа'=>'я','Yo'=>'Ё','Ya'=>'Я',
				'Shc'=>'Щ','Sh'=>'Ш','Ea'=>'И','Ii'=>'Й', 'Zh'=>'Ж','Ch'=>'Ч',
				'Iy'=>'Ю','Ts'=>'Ц','U'=>'У','W'=>'В','V'=>'В','I'=>'И','Y'=>'и',
				'D'=>'Д','T'=>'Т','B'=>'Б','P'=>'П', 'N'=>'Н','F'=>'Ф','Z'=>'З',
				'L'=>'Л','K'=>'К','S'=>'С','M'=>'М','R'=>'Р', 'S'=>'С', 'H'=>'Х',
				'J'=>'Ж','G'=>'Г','A'=>'А','X' => 'Кс', '' => '', 'sc' => 'сц',
				'yu' => 'ю','ey' => 'и','ck' => 'к','ee' => 'и','oo' => 'у', 'ai'=>'ай',
				'yii'=>'ы','jа'=>'я','yo'=>'ё','ya'=>'я', 'shc'=>'щ','sh'=>'ш','ea'=>'и',
				'ii'=>'й','zh'=>'ж','ch'=>'ч', 'iy'=>'ю','ts'=>'ц','u'=>'у','w'=>'в',
				'v'=>'в','i'=>'и','y'=>'и','d'=>'д','t'=>'т','b'=>'б','p'=>'п',
				'n'=>'н','f'=>'ф','\''=>'ь','\''=>'ъ','z'=>'з','l'=>'л','k'=>'к',
				's'=>'с','m'=>'м','r'=>'р','s'=>'с', 'h'=>'х','j'=>'ж','g'=>'г','_'=>'',
				'a'=>'а','q' => 'к','x'=>'кс'
		];
	...
	/**
	 * Safe encode data to json string
	 *
	 * @param mixed $value
	 *
	 * @return string
	 */
	public static function jsonSafeEncode($value)
	{
		...
		switch (json_last_error()) {
			case JSON_ERROR_NONE:
				return $encoded;
			case JSON_ERROR_DEPTH:
				$error = 'Maximum stack depth exceeded'; // or trigger_error() or throw new Exception()
				break;
			case JSON_ERROR_STATE_MISMATCH:
				$error = 'Underflow or the modes mismatch'; // or trigger_error() or throw new Exception()
				break;
			case JSON_ERROR_CTRL_CHAR:
				$error = 'Unexpected control character found';
				break;
			case JSON_ERROR_SYNTAX:
				$error = 'Syntax error, malformed JSON'; // or trigger_error() or throw new Exception()
				break;
			case JSON_ERROR_UTF8:
				$clean = self::utf8ize($value);
				return self::jsonSafeEncode($clean);
			default:
				$error = 'Unknown error'; // or trigger_error() or throw new Exception()
				break;
		}
	...
	/**
	 * Encode to utf8 all values in data
	 *
	 * @param mixed $mixed
	 *
	 * @return array|string
